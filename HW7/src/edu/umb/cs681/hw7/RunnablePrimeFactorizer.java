...
public class RunnablePrimeFactorizer extends PrimeFactorizer implements Runnable {
	...
	public static void main(String[] args) {
		...
		RunnablePrimeFactorizer runnable = new RunnablePrimeFactorizer(26, 2, (long)Math.sqrt(26));
		...
		threads.add(thread);
		System.out.println("Thread Number : " + thread.getId() + 
			" performs factorization in the range of " + runnables.get(0).getFrom() + " To " + runnables.get(0).getTo());
		
		thread = new Thread(runnables.get(1));
		threads.add(thread);
		System.out.println("Thread Number : " + thread.getId() + 
			" performs factorization in the range of " + runnables.get(1).getFrom() + " To " + runnables.get(1).getTo());
